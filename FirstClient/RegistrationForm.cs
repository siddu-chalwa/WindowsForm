        ...
        private void RegisterButton_DataValidation(object sender, MouseEventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ///
                    // File Operation: Storing the data filled by the user to datafile.txt file
                    ///
                    string fileName = "dataFile.txt";
                    File.AppendAllText(fileName, ("Name: " + name_textbox.Text + "\t" + "Age: " + age_textbox.Text + "\t" + "Salary: " + salary_textbox.Text + "\t" + "Email ID: " + emailid_textbox.Text + "\n"));
                    error = false;
                    ClearTextFields();
                    name_textbox.Focus();
                }
