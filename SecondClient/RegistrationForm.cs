...
namespace SecondClient
{
    ...
    {
        private DisplayForm displayFromRef;
        /// <summary>
        ...
        /// </summary>
        public RegistrationForm(ref DisplayForm displayForm)
        {
            InitializeComponent();
            displayFromRef = displayForm;
        }
        /// <summary>
        ...
        private void RegisterButton_DataValidation(object sender, MouseEventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    error = false;
                    delegateForPassingData refVar = new delegateForPassingData(displayFromRef.AssignValuesToTextbox);
